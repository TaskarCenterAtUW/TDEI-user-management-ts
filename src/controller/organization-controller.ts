...
class OrganizationController implements IController {
    ...
    public intializeRoutes() {
        ...
        this.router.delete(`${this.path}/api/v1/organization/:orgId/active/:status`, authorizationMiddleware([Role.TDEI_ADMIN]), this.deleteOrganization);
    }

    public deleteOrganization = async (request: Request, response: express.Response, next: NextFunction) => {
